select [ID], [Short], [Long], isnull([CHILD],0) as [CHILD], isnull([DIS],0) as [DIS], isnull([ELD],0) as [ELD], isnull([EMP],0) as [EMP]
...
,isnull([Off],0) as [Off]
from 
(select a.route_refid as [ID], c.[route_shortname] as [Short], c.[route_longname] as [Long], b.passType_refid as [Rider], sum(b.passenger_on_count) as [Cnt]
